...
public class RedisShardedPool {
    ...
    private static String redis1Ip = PropertiesUtil.getProperty("redis.ip","20");
    private static Integer redis1Port = Integer.parseInt(PropertiesUtil.getProperty("redis.port"));
    private static String redis2Ip = PropertiesUtil.getProperty("redis.ip","20");
    private static Integer redis2Port = Integer.parseInt(PropertiesUtil.getProperty("redis.port"));
    ...
    private static void  initPool(){
        ...
        config.setBlockWhenExhausted(true);//连接耗尽的时候，是否阻塞，false会抛出异常，true阻塞到超时
